 ...
 */
 ...
 public class FishTankAssigner {
   ...
   public static void main(String[] args) throws Exception{
      ...
      System.out.println("The number of aquaria required is: "+chromaticNum);
      // uncomment to see the adjacencies
    /*
     ArrayList<String> grouperAdjacencies =  graph.getAdjacentData("Grouper");
     for(String item: grouperAdjacencies) {
      System.out.println(item);
     }
     ArrayList<String> snailAdjacencies =  graph.getAdjacentData("Snail");
     for(String item: snailAdjacencies) {
      System.out.println(item);
     }
   */
  }
